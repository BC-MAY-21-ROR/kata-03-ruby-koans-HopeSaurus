...
class AboutClassMethods < Neo::Koan
  ...
  # I prefer self.method inside the class it just reduces the nesting and it seems more easy to comprehend
  # also i dont know yet what class << self means (operator << is used to append to arrays, what is it here?)
