...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # It applies a function to the first element of the array (and the paramater of the function, if its not given, defaults as 0)
    # then it saves the result as the left side operand and continues with the second element of the array and so on
    # until all the elements of the array have been utilized
  end
  ...
  #
  # Because you are not pretending to use the file handler anymore so it just wastes more memory
